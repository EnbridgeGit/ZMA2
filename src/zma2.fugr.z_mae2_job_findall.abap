...
*"       TABLES
*"              Z_JOBS_USERS STRUCTURE  YMAEALLJOB
*"       EXCEPTIONS
*"              CLIENT_MISSING
*"              INVALID_DIALOG_TYPE
*"              JOBNAME_MISSING
...
*  a time to run.
*
*  Along with matches we send back a table with the following fields:
*  jobname
*  jobid
*  username - This is the r/3 user who scheduled the batch job
*  date     - The last changed date of the batch job
*  time     - The last changed time stamp.
*
*  This code is the proprietary property of iXOS Software.
*  Copyright (c) 1996 by iXOS Software, All Rights Reserved
*
*  History:
*     Coded 5/22/96 Ravi  Initial coding
*
*
...
*
  ...
  LOOP AT  Z_JOBSELECT_JOBLIST.
    IF Z_JOBSELECT_JOBLIST-RELDATE EQ SPACE OR
      ...
      MOVE Z_JOBSELECT_JOBLIST-JOBCOUNT TO Z_JOBS_USERS-JOBID.
      MOVE Z_JOBSELECT_JOBLIST-JOBNAME TO Z_JOBS_USERS-JOBNAME.
      MOVE Z_JOBSELECT_JOBLIST-LASTCHDATE TO Z_JOBS_USERS-DATE.
      MOVE Z_JOBSELECT_JOBLIST-LASTCHTIME TO Z_JOBS_USERS-TIME.
      MOVE Z_JOBSELECT_JOBLIST-SDLUNAME TO Z_JOBS_USERS-USERNAME.
      MOVE Z_JOBSELECT_JOBLIST-JOBCLASS TO Z_JOBS_USERS-JOBCLASS.
      MATCHES = MATCHES + 1.
      APPEND Z_JOBS_USERS.
    ENDIF.
  ENDLOOP.
